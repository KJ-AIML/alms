"""Narrow secret redaction for raw Anthropic artifacts (DevSpec Section 85).

Local to the probe (probes are isolated and must not import the harness). Masks API keys,
Authorization/Bearer, x-api-key, cookies, and signed-URL signatures; preserves benign
evidence such as request IDs, model IDs, usage, and synthetic content. Byte-identical policy
to the other probes so redaction is consistent across lanes.
"""
